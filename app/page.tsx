...
function DesktopPathCard({
  ...
  return (
    <Paper
      ...
      href={href}
      elevation={0}
      className={`group relative flex min-h-[24.5rem] flex-col overflow-hidden border border-[rgba(119,118,125,0.35)] bg-[#fdf9ef] p-6 transition-transform duration-200 active:scale-[0.985] md:p-8 ${cardClassName}`}
      sx={{
        borderRadius: "8px",
    ...
    >
      <div className={`absolute -top-3 z-20 h-6 ${tapeClassName} border border-black/5 shadow-sm`} />
      ...
      <div className="absolute left-5 top-5 max-h-[5.2rem] max-w-[17rem] overflow-hidden text-[0.55rem] leading-[1.35] text-[#1c1c16] opacity-[0.08] md:text-[0.7rem]">
        {snippet.map((line) => (
          <div key={line}>{line}</div>
        ))}
      </div>

      <Typography component="p" className="relative z-10 mb-6 max-w-[19ch] !font-[var(--font-body)] !text-[1.05rem] !leading-[1.55] text-[#46464c] md:max-w-[24ch]">
        {description}
      </Typography>
    ...
    <Link href={href} className="group relative block w-full">
      <div
        className={`absolute -top-3 z-20 h-6 border border-black/5 shadow-sm backdrop-blur-[2px] ${
          tape === "teal"
            ? "right-6 w-16 rotate-[-2deg] bg-[rgba(27,172,163,0.6)]"
      ...
      >
        ...
        <p className="mb-6 text-base leading-[1.5] text-[#46464c]" style={{ fontFamily: "var(--font-body), sans-serif" }}>
          {description}
        </p>
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#fdf9ef] text-[#1c1c16]">
      <div className="md:hidden">
        <div className="min-h-[max(884px,100dvh)] bg-[linear-gradient(#ece8de_1px,transparent_1px),linear-gradient(90deg,#ece8de_1px,transparent_1px)] bg-[size:20px_20px] px-6 py-12">
          <section className="mx-auto flex w-full max-w-sm flex-col items-center justify-center gap-8">
            ...
            <div className="z-10 mt-8 pb-8 text-center">
              <Link
              ...
              >
                ...
                <span className="absolute -bottom-[2px] left-0 -z-10 h-1 w-full rotate-[-1deg] rounded-full bg-[#ff6b6b]" />
              </Link>
            </div>
          </section>
        </div>
      ...
      <div className="hidden md:block">
        <div className="relative min-h-screen bg-[linear-gradient(180deg,#fdf9ef_0%,#fdf9ef_100%)] px-4 py-10 sm:px-6 lg:px-8">
          ...
          <section className="relative mx-auto flex min-h-[100svh] w-full max-w-[1120px] flex-col justify-center gap-8">
            <header className="relative z-10 text-center">
              ...
              <Typography component="p" className="mb-3 !font-[var(--font-mono)] !text-[0.8rem] !tracking-[0.16em] uppercase text-[#5f6471]">
                b1kjuu.dev
              </Typography>
              ...
              <Typography component="p" className="mx-auto max-w-[34ch] !font-[var(--font-body)] !text-[1.15rem] !leading-[1.55] text-[#46464c]">
                Which side of my work would you like to explore today?
              </Typography>
            </header>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <DesktopPathCard
                ...
                description="Dive into lines of code, system architectures, and the digital tools I've built from the ground up."
                cta="Explore Code"
                tapeClassName="right-6 w-16 bg-[rgba(27,172,163,0.6)] rotate-[-2deg] md:w-[4.8rem]"
              ...
              <DesktopPathCard
                ...
                cta="View Reel"
                tapeClassName="left-6 w-20 bg-[rgba(255,107,107,0.6)] rotate-[1.5deg] md:w-[5rem]"
                cardClassName="-rotate-[0.5deg] md:-rotate-[0.35deg]"
